...
class ChurchHistoryViewsTest(test_case.AdministratorTestCase):
    ...
    def test_create(self):
        data = {
            "history_list": [
                {"year": "2023", "month": "04", "day": "03", "content": "내용"},
                {"year": "2022", "month": "04", "day": "30", "content": "내용"},
            ],
        }
        ...
        self.assertEqual(histories[1].year, "2022")
    ...
    def test_patch(self):
        ...
        self.assertEqual(ChurchHistory.objects.get(year="2021").content, "@52414525")
