    ...
    def create(self, request):
        ...
        try:
            ...
            for history in history_list:
                year = history.get("year", None)
                month = history.get("month", None)
                day = history.get("day", None)
        ...
        try:
            ...
            for index, church_history in enumerate(church_histories):
                ...
                if year or month or day:
                    year = year if year else church_history.year
                    month = month if month else church_history.month
                    day = day if day else church_history.day
